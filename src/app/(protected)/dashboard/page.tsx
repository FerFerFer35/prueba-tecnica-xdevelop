            ...
            <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                    ...
                    <div className="mt-3 text-xs text-zinc-500 sm:mt-0">
                        Tip: Users usa ReqRes, Posts usa JSONPlaceholder y Foods usa USDA FoodData Central.
                    </div>
                </div>
                ...
                <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <StatsCard
                        title="Alimentos — USDA"
                        description="Busca alimentos y consulta información nutricional desde USDA FoodData Central."
                        href="/foods"
                        cta="Ir a Foods"
                        badge="/foods"
                    />
